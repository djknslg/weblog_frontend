        ...
        <div
          ...
          <article>
            ...
            <div class="text-gray-400 flex items-center mt-5 text-sm">
              ...
              <span class="hidden md:inline mr-1">分类于</span><a @click="goCategoryArticleListPage(article.categoryId, article.categoryName)" class="hover:underline">{{ article.categoryName }}</a>
              ...
              </svg> <span class="hidden md:inline mr-1">阅读量</span> {{ article.readNum }}
...
import Toc from '@/layouts/frontend/Toc.vue'
const route = useRoute()
const router = useRouter()
// 路由传递过来的文章 ID
console.log("saknfadhfkodsfds",route.params.articleId)
...
function refreshArticleDetail(articleId) {
  getArticleDetail(articleId).then((res) => {
    if (res.success) {
      ...
      console.log("文章详情列表",res.data)
    }else if (res.errorCode=='20010'){
      // 手动跳转 404 页面
